...
Engine.prototype.loadEngine = function(filename, callback) {
	...
	fs.stat(filename, function(err, stats) {
		...
		// Create instance
		engine.instance = new engine.prototype(self.app.frex, engine);
//		engine.instance.engine = engine;

		if (!engine.hasOwnProperty('constructor')) {

			// Activate engine to create instance
			self.activateEngine(engine, function(err, runtime) {
...
Engine.prototype.activateEngine = function(engine, callback) {
	var self = this;
